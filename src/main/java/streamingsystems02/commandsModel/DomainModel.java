...
/**
 * Collection of verification methods for the commands that have their own
 * models.
 */
public class DomainModel {
    ...
    /**
     * Check if the moving items exists and throw an exception if it does not.
     *
     ...
     * @return True if an item exists at the position, false otherwise.
     */
    ...
    /**
     * @param positionToFind The position to find.
     * @return The name of the first moving item found at the position or null if no moving item was found.
     */
    ...
    /**
     * Increment the number of moves for the moving item name.
     *
     * @param movingItemName The name of the moving item.
     */
     ...
     * @return True if the maximum number of moves for the moving item id has
